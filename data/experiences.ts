...
export const experiences: Experience[] = [
	...
	},
	{
		...
		overview: "I established the U.S. chapter of AquaMeridian, an international marine conservation initiative, and built it into a sustained, student-led organization over four years. I designed and ran programs spanning large-scale coastal cleanups, STEM education workshops, community partnerships, and our Annual Student Leadership Forum, engaging over 300 members across the chapter's lifetime. I also built the funding from scratch, trained a leadership pipeline that kept the chapter running without me, and partnered with DOER Marine and CASA (Community Action for a Sustainable Alameda) as core collaborators for all beach cleanups, alongside schools, libraries, and organizations like the Monterey Bay Giant Kelp Restoration Project supporting marine education and habitat restoration.",
		responsibilities: [
			"Founded and led the U.S. chapter of AquaMeridian, building it from the ground up into a sustained, student-run organization.",
			"Recruited, trained, and mentored a 12-person student leadership team, building a succession plan so the chapter could run independently.",
			"Directed strategic planning, fundraising strategy, and day-to-day operations across all programs.",
			"Built and maintained core partnerships with DOER Marine and CASA for all beach cleanups, alongside broader collaborations with Mission Blue, Shine4Love Teens Club, and the Monterey Bay Giant Kelp Restoration Project (G2KR).",
			"Organized monthly beach cleanups, submitting collected debris data to global ocean health databases.",
		...
		achievements: [
			...
			"Raised $8,500+ from corporate sponsors and individual donors.",
			"Mobilized 150+ volunteers and collected 2,000+ lbs of marine debris.",
			"Reached 200+ students through education panels and STEM workshops.",
			"Featured in the Alameda Post for student-led environmental leadership work.",
			"Built a 12-person student leadership pipeline that continues to run the organization independently.",
		],
